...
' Note: Only applies to Microsoft Word 2016 and later.
'
' Usage
' =====
' STEP 1.
...
'   by @aevanko
'     Link from: https://stackoverflow.com/a/7087145
...
' Run `Sub Shortcut_Keys_Customization()` to see in the visible pane
    ...
    KeyBindings.Add KeyCode:=BuildKeyCode(wdKeyS, wdKeyAlt), KeyCode2:= _
        BuildKeyCode(wdKeyC), KeyCategory:=wdKeyCategoryCommand, Command:="Eqn_Sym_Correction_MathML"
