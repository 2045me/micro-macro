...
End Sub
Sub Eqn_Bookmark()
Attribute Eqn_Bookmark.VB_ProcData.VB_Invoke_Func = "Normal.NewMacros.Macro1"
...
'     and you can paste it directly to your target location)
    ...
    If InStr(Selection, "Eqn__") Then
        ...
        ' Equivalent to
        '   `(Eqn__.*\w)(?<![\\}])`
        ' This is how to use "Negative Lookahead" to simulate "Negative Lookbehind" in VBA regex.
        ' Explanation:
...
Attribute Shortcut_Keys_Preset_Assignment.VB_ProcData.VB_Invoke_Func = "Normal.NewMacros.Macro1"
